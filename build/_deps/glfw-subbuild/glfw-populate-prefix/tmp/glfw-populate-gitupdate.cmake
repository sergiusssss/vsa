...
function(do_fetch)
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/Student/Desktop/karagodina/vsa/build/_deps/glfw-src"
...
execute_process(
  COMMAND "C:/Users/Student/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "7b6aead9fb88b3623e3b3725ebb42670cbe4c579"
  WORKING_DIRECTORY "C:/Users/Student/Desktop/karagodina/vsa/build/_deps/glfw-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Student/Desktop/karagodina/vsa/build/_deps/glfw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Student/Desktop/karagodina/vsa/build/_deps/glfw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
